...
__or FUNCTION
	 PUSH {LR};	 
	 VLDR.F32 S4,= 2;			Weight W1
	 VLDR.F32 S5,= 2;			Weight W2
	 VLDR.F32 S6,= 2;			Weight W3
	 VLDR.F32 S7,= -1;			our Bias
	 VMUL.F32 S0,S0,S4;			A1*W1
	 VMUL.F32 S1,S1,S5;			A2*W2
	 VMUL.F32 S2,S2,S6;			A3*W3
	 VADD.F32 S3,S0,S1;			A1*W1 + A2*W2 
...
;----------------------------------------------------------------------------------------
;		logic NOT, only consider 1st input (in R4) for NOT 
